...
const items = [
  ...
  { label: 'Calendario', icon: 'i-lucide-calendar-days', to: '/admin/calendario' },
...
<template>
  <nav
    class="fixed bottom-4 inset-x-4 z-40
           flex items-center justify-around gap-1
           h-16 p-1.5 rounded-2xl
           bg-elevated/80 backdrop-blur-lg
           border border-default/60
           shadow-lg shadow-black/5
           supports-[backdrop-filter]:bg-elevated/65
           safe-area-bottom"
  >
    <NuxtLink
      v-for="item in items"
